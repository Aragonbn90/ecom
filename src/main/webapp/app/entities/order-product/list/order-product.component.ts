...
export class OrderProductComponent implements OnInit {
  ...
  constructor(protected orderProductService: OrderProductService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.orderProducts = [];
  ...
  loadAll(): void {
    ...
    this.orderProductService
      ...
      .subscribe({
        next: (res: HttpResponse<IOrderProduct[]>) => {
          this.isLoading = false;
          this.paginateOrderProducts(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateOrderProducts(data: IOrderProduct[] | null, headers: HttpHeaders): void {
